	...
	return (
		<>
			<PageSection first className="gap-8 md:flex-row md:items-center">
				<Image src="/img/me.JPG" alt="picture of me" width={1000} height={1000} className="rounded-xl max-md:w-48 md:w-64 md:h-64 md:order-1" />
				<div className="flex flex-col justify-center md:gap-8 gap-2">
					<small className=""><span className="text-accent">~/portfolio</span> $ cat intro.txt</small>
					<Typewriter text="hi, bowen here. 👋" className="text-accent md:text-4xl text-xl text-nowrap" />
					<p className="text-muted text-xs md:text-base">{age}yo software engineer from Malaysia</p>
